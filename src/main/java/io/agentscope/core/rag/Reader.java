...
public interface Reader {
     ...
     * @return a Mono that emits a list of Document objects
     * @throws ReaderException if document reading fails
     */
    Mono<List<Document>> read(ReaderInput input) throws ReaderException;
