...
class TextReaderTest {
    ...
    void testRead() throws io.agentscope.core.rag.model.ReaderException {
    ...
    void testDocumentMetadata() throws io.agentscope.core.rag.model.ReaderException {
        TextReader reader = new TextReader(10, SplitStrategy.CHARACTER, 0);
    ...
    void testMultipleDocuments() throws io.agentscope.core.rag.model.ReaderException {
    ...
    void testEmptyText() throws io.agentscope.core.rag.model.ReaderException {
        TextReader reader = new TextReader(10, SplitStrategy.CHARACTER, 0);
    ...
    void testNullInput() throws io.agentscope.core.rag.model.ReaderException {
        TextReader reader = new TextReader();

        StepVerifier.create(reader.read(null))
                .expectError(io.agentscope.core.rag.model.ReaderException.class)
                .verify();
    }

    @Test
    @DisplayName("Should use different strategies correctly")
    void testDifferentStrategies() throws io.agentscope.core.rag.model.ReaderException {
    ...
    void testContentPreservation() throws io.agentscope.core.rag.model.ReaderException {
