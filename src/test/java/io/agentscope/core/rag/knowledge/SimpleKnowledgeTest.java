...
class SimpleKnowledgeTest {
    ...
    @Test
    @DisplayName("Should handle errors gracefully when adding documents")
    void testAddDocumentsWithError() {
        ...
        StepVerifier.create(errorKB.addDocuments(List.of(doc))).verifyComplete();
    }
