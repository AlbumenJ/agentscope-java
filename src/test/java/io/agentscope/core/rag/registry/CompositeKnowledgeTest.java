...
class CompositeKnowledgeTest {

    private static final int DIMENSIONS = 3;

    private Knowledge kb1;
    private Knowledge kb2;
    private CompositeKnowledge composite;
    ...
    void setUp() {
        ...
        composite = new CompositeKnowledge(List.of(kb1, kb2));
    }

    @Test
    @DisplayName("Should create CompositeKnowledgeBase with valid knowledge bases")
    void testCreate() {
        CompositeKnowledge newComposite = new CompositeKnowledge(List.of(kb1, kb2));
    ...
    void testCreateNullList() {
        assertThrows(IllegalArgumentException.class, () -> new CompositeKnowledge(null));
    }

    @Test
    @DisplayName("Should throw exception for empty knowledge bases list")
    void testCreateEmptyList() {
        assertThrows(IllegalArgumentException.class, () -> new CompositeKnowledge(List.of()));
    }

    @Test
    @DisplayName("Should throw exception for null knowledge base in list")
    void testCreateWithNullKnowledgeBase() {
        List<Knowledge> listWithNull = new java.util.ArrayList<>();
    ...
    void testGetKnowledgeBases() {
        List<Knowledge> bases = composite.getKnowledgeBases();
