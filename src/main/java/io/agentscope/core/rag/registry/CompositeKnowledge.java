 ...
 *
 * <p>This class implements the {@link Knowledge} interface and combines multiple
 ...
 * }</pre>
 */
public class CompositeKnowledge implements Knowledge {
     ...
     *
     * @param knowledges the list of knowledge bases to aggregate (must not be null or empty)
     * @throws IllegalArgumentException if knowledgeBases is null or empty
     */
    public CompositeKnowledge(List<Knowledge> knowledges) {
        if (knowledges == null) {
        ...
        this.knowledges = new ArrayList<>(knowledges);
    }
    ...
    public Mono<Void> addDocuments(List<Document> documents) {
        ...
        return Flux.fromIterable(knowledges).flatMap(kb -> kb.addDocuments(documents)).then();
    }
    ...
    public Mono<List<Document>> retrieve(String query, RetrieveConfig config) {
        ...
        return Flux.fromIterable(knowledges)
     ...
     */
    public List<Knowledge> getKnowledgeBases() {
        return List.copyOf(knowledges);
    }
}
