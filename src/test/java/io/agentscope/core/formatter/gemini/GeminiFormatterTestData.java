 ...
 * Contains message fixtures and ground truth data extracted from Python tests.
 */
public class GeminiFormatterTestData {
    ...
    /**
     * Ground truth for GeminiChatFormatter (from Python tests).
     * This is the expected output for: system + conversation + tools
     *
    ...
    /**
     * Ground truth for GeminiMultiAgentFormatter (from Python tests).
     * This is the expected output for: system + conversation + tools
     *
     * @return JSON string of expected output
     */
