    ...
    void setUp() {
        ...
        mockAgent =
                new AgentBase("MockAgent") {
                    @Override
                    protected reactor.core.publisher.Mono<Msg> doCall(Msg msg) {
                        return reactor.core.publisher.Mono.just(msg);
                    }

                    @Override
                    protected reactor.core.publisher.Mono<Msg> doCall(List<Msg> msgs) {
                        return reactor.core.publisher.Mono.just(msgs.get(0));
                    }
                    ...
                    @Override
                    protected reactor.core.publisher.Mono<Msg> handleInterrupt(
